...
def create_manifest3(identifier, domain=None, page=None):
    ...
    if mediatype == 'texts':
        ...
        for file in [f for f in originals if f['format'] in ['VBR MP3', '128Kbps MP3', '96Kbps MP3', '64Kbps MP3', '56Kbps MP3', '32Kbps MP3', 'MPEG-4 Audio', 'Flac', 'AIFF', 'Apple Lossless Audio', 'Ogg Vorbis', 'WAVE', '24bit Flac', 'Shorten']]:
            ...
            if file['name'] in derivatives:
                ...
                for format in ['VBR MP3', '128Kbps MP3', '96Kbps MP3', '64Kbps MP3', '56Kbps MP3', '32Kbps MP3', 'MPEG-4 Audio', 'Flac', 'AIFF', 'Apple Lossless Audio', 'Ogg Vorbis', 'WAVE', '24bit Flac', 'Shorten']:
