...
$(document).ready(function() {
    xannotate.setup = function(mirador) {
	mirador.viewer.eventEmitter.subscribe('manifestReceived', function(event, manifest) {
		    ...
		    $('.workspace-container').before().append('<div class="xannotate-widget"><form><input class="xannotate-source" value="" placeholder="Source"/><input class="xannotate-target" placeholder="Target"/><button id="xannotate-submit">Link</button></form></div>');
		    loaded = true;
		        }
	    });
    ...
    $('.xannotate-activate').click(function() {
